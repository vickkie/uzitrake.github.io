  ...
  function emojiSafeSplit(D, u, F, C) {
    ...
    for (var E, e, t = [], i = D.length, n = 0; n < i; n++)
      ((55296 <= (e = D.charAt(n)).charCodeAt(0) && e.charCodeAt(0) <= 56319) ||
        ...
        ((E = ((D.substr(n, 12).split(s) || [])[1] || "").length || 2), (e = D.substr(n, E)), (n += E - (t.emoji = 1))),
        t.push(
          ">" === e
            ? "&gt;"
            : "<" === e
            ? "&lt;"
            : !C || " " !== e || (" " !== D.charAt(n - 1) && " " !== D.charAt(n + 1))
            ? e
            : "&nbsp;"
        );
    return t;
  ...
  var u,
    ...
    e = {
      ...
      init: function init(D, u, F) {
        if (
          (o || p(), (this.prop = "innerHTML" in D ? "innerHTML" : "textContent" in D ? "textContent" : 0), this.prop)
        ) {
      ...
      render: function render(D, u) {
        ...
        g &&
          ...
          (n = H
            ? ((t = (r = _ ? v : T) && 0 != F) ? "<span class='" + r + "'>" : "") +
              E +
              (t ? "</span>" : "") +
              ((i = (s = _ ? T : v) && F !== I) ? "<span class='" + s + "'>" : "") +
              h +
              e +
              (i ? "</span>" : "")
            : E + h + e),
